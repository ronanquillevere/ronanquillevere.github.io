...
The following code can be found on github <i class="fa fa-github" style="font-size:2rem"></i> [https://github.com/ronanquillevere/gwtrestapp](https://github.com/ronanquillevere/gwtrestapp)
